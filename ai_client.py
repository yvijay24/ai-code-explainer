...
class AIClient:
    ...
    def explain_code(self, code: str, language: str, ast_summary: Optional[str] = None) -> Dict:
        ...
        user_prompt = (
            ...
            "IMPORTANT:\n"
            "- optimized_code MUST NOT be empty\n"
            "- If no performance optimization is possible, improve code style, indentation, clarity\n"
            "- If loops or repeated console logs exist, batch or extract them\n"
